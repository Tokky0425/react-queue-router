...
let rootNode
const Top = () => <div><h1>Top page</h1></div>
const About = () => <div><h1>About page</h1></div>
const User = ({params}) => <div><h1>User page (ID: {params.id})</h1></div>
const UserPost = ({params}) => <div><h1>User Post page (ID: {params.id}, PostID: {params.postId})</h1></div>
const NotFound = () => <div><h1>404 page</h1></div>
